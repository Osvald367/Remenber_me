...
class AbonnementInactifPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final abonnementsInactifs =
        abonnements.where((abonnement) => abonnement['actif'] == false).toList();
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                itemCount: abonnementsInactifs.length,
                itemBuilder: (context, index) {
                  final abonnement = abonnementsInactifs[index];
                  Color iconColor = Colors.grey; // Couleur fixe pour actifs
